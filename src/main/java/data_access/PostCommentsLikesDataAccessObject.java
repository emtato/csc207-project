...
public interface PostCommentsLikesDataAccessObject {
    void addComment(long parentID, Account user, String contents, LocalDateTime timestamp);

    ArrayList<Comment> getComments(long parentID);
...
//    void deleteReview(long reviewID);
     ...
     */
    void addLike(Account user, long postID);
     ...
     */
    boolean postIsLiked(Account user, long postID);
     ...
     */
    void writePost(long postID, Account user, String title, String postType, String description,
...
//    Review getReview(long reviewID);
     ...
     */
    void updateLikesForPost(long postID, int likeDifference);
     ...
     */
    ArrayList<Long> getAvailablePosts();
//    public ArrayList<Long> getAvailableReviews();
     ...
     */
    void addPostToClub(Post post, long clubId) throws DataAccessException;
