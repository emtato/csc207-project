...
public class SettingsViewModel extends ViewModel<SettingsState> {
    ...
    public static final int SETTINGS_PANEL_WIDTH = GUIConstants.WINDOW_WIDTH; //old -> 1200;
    public static final int SETTINGS_PANEL_HEIGHT = GUIConstants.WINDOW_HEIGHT; // old -> 600;
