...
public class EditProfileViewModel extends ViewModel<EditProfileState> {
    ...
    public static final int EDIT_PANEL_WIDTH = (int) (GUIConstants.WINDOW_WIDTH * 0.5);
    public static final int EDIT_PANEL_HEIGHT = (int) (GUIConstants.WINDOW_HEIGHT * 0.8);
