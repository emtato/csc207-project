...
import use_case.list_clubs.ListClubsOutputData;

public class ListClubsPresenter implements ListClubsOutputBoundary {
    private final ClubViewModel clubViewModel;

    public ListClubsPresenter(ClubViewModel clubViewModel) {
        this.clubViewModel = clubViewModel;
    }

    @Override
    public void prepareSuccessView(ListClubsOutputData outputData) {
