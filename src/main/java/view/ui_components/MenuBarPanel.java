...
public class MenuBarPanel extends JPanel {
    public MenuBarPanel(ViewManagerModel viewManagerModel) {
        ...
        ImageIcon clubsIcon = new ImageIcon("/images/toppng.com-white-person-icon-people-white-icon-abstract-backgrounds-436x368.png");
        ...
        ImageIcon settingsIcon = new ImageIcon("/images/[CITYPNG.COM]Settings White Outline Icon Download PNG - 1500x1500.png");
        ...
        ImageIcon exploreIcon = new ImageIcon("/images/[CITYPNG.COM]Search Explore White Icon Transparent PNG - 4000x4000.png");
        ...
        ImageIcon notificationsIcon = new ImageIcon("/images/appointment-reminders.png");
